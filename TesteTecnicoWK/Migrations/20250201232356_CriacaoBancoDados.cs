            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Cod_Usuario = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Des_NomeUsuario = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Des_Email = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Des_Login = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cod_Perfil = table.Column<int>(type: "int", nullable: false),
                    ...
                    Dta_Atualizacao = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tab_Usuario", x => x.Cod_Usuario);
                });
